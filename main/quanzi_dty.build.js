...
import PageClass from './quanzi_dty.user';
...
var methods = {
$evtH_button4_tap: function({$event,$data,restData,aggregateData,restData1,$item,params,$page,restData2,props,restData3}){
...
,
 $attrBindFn_text_view5: function({list1index,restData,aggregateData,restData1,list1item,params,$page,restData2,props,restData3}){
...
,$evtH_button_tap: function({$event,$data,restData,aggregateData,restData1,$item,params,$page,restData2,props,restData3}){
let $$$args = arguments[0];
	let args={};
...
,
 $filter__system1__restData2: function({restData,nlike,aggregateData,lt,restData1,restData2,restData3,not,gte,neq,lte,$page,isNotNull,$$dataObj,like,RBRAC,inn,is,params,eq,gt,props,LBRAC,isNull,ilike,nilike}){
 	return eq('fyonghuopenid',restData3.current.id/*{"dependencies":["restData3"]}*/, $$dataObj);
 ;
}

,
 $items_list1: function({list1index,restData,aggregateData,restData1,list1item,params,$page,restData2,props,restData3}){
 return restData1.value ;
}

,
 $filter__system1__restData1: function({restData,nlike,aggregateData,lt,restData1,restData2,restData3,not,gte,neq,lte,$page,isNotNull,$$dataObj,like,RBRAC,inn,is,params,eq,gt,props,LBRAC,isNull,ilike,nilike}){
 	return eq('fjuanziid',params.param0, $$dataObj);
 ;
}

,$evtH_button5_tap: function({list1index,$event,$data,restData,aggregateData,restData1,params,restData2,props,restData3,list1item,$item,$page}){
let $$$args = arguments[0];
	let args={};
...
,
 $attrBindFn_disabled_button1: function({list1index,restData,aggregateData,restData1,list1item,params,$page,restData2,props,restData3}){
 try{return wx.Util.iif(restData2.current.fsanyuzt!=null,true,false)}catch(e){return ''} ;
}

,
 $attrBindFn_text_text6: function({restData,aggregateData,restData1,params,$page,restData2,props,restData3}){
 try{return wx.Util.iif(aggregateData.current.countfid==null,"0",aggregateData.current.countfid)}catch(e){return ''} ;
}

,
 $attrBindFn_disabled_button5: function({list1index,restData,aggregateData,restData1,list1item,params,$page,restData2,props,restData3}){
...
,
 $attrBindFn_text_view1: function({list1index,restData,aggregateData,restData1,list1item,params,$page,restData2,props,restData3}){
 try{return wx.Util.iif(restData2.current.fsanyuzt!=null,"已加入","加入")}catch(e){return ''} ;
}

,
 $imageUrlFn_image2: function({list1index,restData,aggregateData,restData1,list1item,$item,params,$page,restData2,props,restData3}){
 return list1item.fzhaopian ;
}

,
 $filter__system2__restData2: function({restData,nlike,aggregateData,lt,restData1,restData2,restData3,not,gte,neq,lte,$page,isNotNull,$$dataObj,like,RBRAC,inn,is,params,eq,gt,props,LBRAC,isNull,ilike,nilike}){

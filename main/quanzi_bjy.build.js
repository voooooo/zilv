...
import PageClass from './quanzi_bjy.user';
...
var methods = {
$evtH_input3_valuechange: function({$event,$data,restData,restData1,$item,params,$page,restData2,props}){
let $$$args = arguments[0];
	let args={};
	args={"col":"fjuanzidksj","item":"restData.current.fjuanzidksj","data":"restData"};
...
,$evtH_input4_valuechange: function({$event,$data,restData,restData1,$item,params,$page,restData2,props}){
let $$$args = arguments[0];
	let args={};
	args={"col":"fjuanzidkjssj","item":"restData.current.fjuanzidkjssj","data":"restData"};
	args.row=restData.current;
	args.value=$event.value;
	return $page.$compByCtx('commonOperation',$event.source).executeOperation('setValue', args, $$$args);
...
,$evtH_input_valuechange: function({$event,$data,restData,restData1,$item,params,$page,restData2,props}){
let $$$args = arguments[0];
	let args={};
	args={"col":"fquanzimc","item":"restData.current.fquanzimc","data":"restData"};
	args.row=restData.current;
	args.value=$event.value;
	return $page.$compByCtx('commonOperation',$event.source).executeOperation('setValue', args, $$$args);
...
,$evtH_input1_valuechange: function({$event,$data,restData,restData1,$item,params,$page,restData2,props}){
let $$$args = arguments[0];
	let args={};
	args={"col":"fjuanziksrj","item":"restData.current.fjuanziksrj","data":"restData"};
	args.row=restData.current;
	args.value=$event.value;
	return $page.$compByCtx('commonOperation',$event.source).executeOperation('setValue', args, $$$args);
...
,$evtH_textarea_valuechange: function({$event,$data,restData,restData1,$item,params,$page,restData2,props}){
let $$$args = arguments[0];
	let args={};
	args={"col":"fdakagz","item":"restData.current.fdakagz","data":"restData"};
	args.row=restData.current;
	args.value=$event.value;
	return $page.$compByCtx('commonOperation',$event.source).executeOperation('setValue', args, $$$args);
...
,$evtH_textarea1_valuechange: function({$event,$data,restData,restData1,$item,params,$page,restData2,props}){
let $$$args = arguments[0];
	let args={};
	args={"col":"fjuanzijs","item":"restData.current.fjuanzijs","data":"restData"};
	args.row=restData.current;
	args.value=$event.value;
	return $page.$compByCtx('commonOperation',$event.source).executeOperation('setValue', args, $$$args);
...
,$evtH_input2_valuechange: function({$event,$data,restData,restData1,$item,params,$page,restData2,props}){
let $$$args = arguments[0];
	let args={};
	args={"col":"fjuanzijsrj","item":"restData.current.fjuanzijsrj","data":"restData"};
	args.row=restData.current;
	args.value=$event.value;
	return $page.$compByCtx('commonOperation',$event.source).executeOperation('setValue', args, $$$args);
...
var template = [
	...
	},
	{
		...
		"props":{
			...
			"$refFn":"$refFn_input",
			"$events":{
				"valuechange":"$evtH_input_valuechange"
			},
			"id":"input",
	...
	},
	{
		...
		"props":{
			...
			"$refFn":"$refFn_input1",
			"$events":{
				"valuechange":"$evtH_input1_valuechange"
			},
			"id":"input1",
	...
	},
	{
		...
		"props":{
			...
			"$refFn":"$refFn_input2",
			"$events":{
				"valuechange":"$evtH_input2_valuechange"
			},
			"id":"input2",
	...
	},
	{
		...
		"props":{
			...
			"$refFn":"$refFn_input3",
			"$events":{
				"valuechange":"$evtH_input3_valuechange"
			},
			"id":"input3",
	...
	},
	{
		...
		"props":{
			...
			"$refFn":"$refFn_input4",
			"$events":{
				"valuechange":"$evtH_input4_valuechange"
			},
			"id":"input4",
	...
	},
	{
		...
		"props":{
			...
			"$events":{
				"valuechange":"$evtH_textarea1_valuechange"
			},
			"id":"textarea1",
	...
	},
	{
		...
		"props":{
			...
			"$events":{
				"valuechange":"$evtH_textarea_valuechange"
			},
			"id":"textarea",
